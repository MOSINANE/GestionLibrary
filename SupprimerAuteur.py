...
labelAff = customtkinter.CTkLabel(root,text="Chercher par Id Auteur",width=120,height=25, bg_color='black')
...
def removeRecord():
    ...
    if selected:
        ...
        sql = 'DELETE FROM auteur WHERE Id_Aut = %s'
